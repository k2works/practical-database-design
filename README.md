...
|----|----------|------|
| 第33章 | システム統合の概要 | 未着手 |
| 第34章 | メッセージングパターン | 未着手 |
| 第35章 | システム間連携パターン | 未着手 |
| 第36章 | マスタデータ管理（MDM） | 未着手 |
| 第37章 | イベント駆動アーキテクチャ | 未着手 |
| 第38章 | API 設計とサービス連携 | 未着手 |
| 第39章 | データ連携の実装パターン | 未着手 |
...
- [SMS ER 図](https://k2works.github.io/practical-database-design/assets/schemaspy-output/sms/index.html)
- [FAS ER 図](https://k2works.github.io/practical-database-design/assets/schemaspy-output/fas/index.html)
- [PMS ER 図](https://k2works.github.io/practical-database-design/assets/schemaspy-output/pms/index.html)
